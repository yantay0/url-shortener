...
func (app *App) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	if err != nil {
		...
		case errors.As(err, &syntaxError):
			return fmt.Errorf("body contaions badly-formed JSON (at character %d)", syntaxError.Offset)
		...
		case strings.HasPrefix(err.Error(), "json: unknown field"):
			fieldName := strings.TrimPrefix(err.Error(), "json: unknowd field")
...
// returns string value\defalut from query string
